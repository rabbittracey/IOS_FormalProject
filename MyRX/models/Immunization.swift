...
//        guard case .Ok(let reminder) = ImmunizationReminder.instance(value["reminder"])  else {
//            
//        }
        ...
        immunization.vaccine_lot=value["vaccine_lot"] as?  String
         ...
         immunization.version=value["version"] as?  String
         immunization.is_archived=value["is_archived"] as? String
